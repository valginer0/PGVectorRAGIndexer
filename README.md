...
### 🆕 Latest Fixes (v2.14.3)

- **✅ Bulk Folder Indexing Rate-Limit Resilience**: Desktop App bulk imports, metadata probes, and watched-folder scans bypass the generic API limiter and retry residual 429 responses without corrupting multipart uploads.

### Recent Features (v2.14.2)

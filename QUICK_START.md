...
- **Bulk Folder Indexing Rate-Limit Resilience**: Large Desktop App folder imports now bypass the generic API limiter and retry residual 429 responses safely.
